...
# nothing beside it on disk. Kept byte-identical to what the package renders
# from its claude recipe; tests/test_script.py enforces that.
CONTAINERFILE = r"""# Rendered by sanduk from recipe claude. Edit the recipe instead.
